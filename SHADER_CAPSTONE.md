...
| --- | --- |
| Custom fragment shader | `src/lib/hero-shader.ts` — cinema aurora (FBM noise + violet/gold palette) |
...
| File | Role |
| --- | --- |
| `src/lib/hero-shader.ts` | GLSL source + DPR helper |
