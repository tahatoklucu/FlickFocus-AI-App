...
const INSTAGRAM_URL = "https://www.instagram.com/tahatoklucu/";
const LINKEDIN_URL = "https://www.linkedin.com/in/tahatoklucu/";
    ...
    <footer className="border-t border-neutral-800/60 bg-neutral-950/80 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-4 py-6 sm:flex-row sm:px-6 sm:py-8 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <SocialLink href={INSTAGRAM_URL} label="Follow Taha Toklucu on Instagram">
            <InstagramIcon />
          </SocialLink>
          <SocialLink href={LINKEDIN_URL} label="Connect with Taha Toklucu on LinkedIn">
            <LinkedInIcon />
          </SocialLink>
        </div>
      </div>
