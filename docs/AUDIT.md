...
| **GLSL hero shader (capstone)** | `src/lib/hero/hero-shader.ts`, `src/components/hero/HeroShaderBackground.tsx`, `src/components/hero/HomePageHero.tsx` — see [SHADER_CAPSTONE.md](./SHADER_CAPSTONE.md) |
...
| --- | --- | --- |
| Custom GLSL shader | ✅ | `src/lib/hero/hero-shader.ts` |
